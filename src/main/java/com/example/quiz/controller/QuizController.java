...
public class QuizController {
	...
	/** idをKeyにしてデータを更新する */
	@PostMapping("/update")
	public String update(@Validated QuizForm quizForm, BindingResult result, Model model, RedirectAttributes redirectAttributues) {
		//QuizFormからQuizに詰め直す
		...
		if(!result.hasErrors()) {
			...
			redirectAttributues.addFlashAttribute("complete", "更新が完了しました");
			//更新画面を表示する
			return "redirect:/quiz";
		} else {
			//更新用のModelを作成する
